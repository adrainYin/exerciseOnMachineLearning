...
# weakClassArr = adaBoosting.adaBoostingTrain(dataMat , labelMat , 10)
...
dataArr , labelArr = adaBoosting.loadDataSet('CH07_data/horseColicTest2.txt')
classifierArr , aggClassEst = adaBoosting.adaBoostingTrain(dataArr , labelArr , 10)
adaBoosting.plotROC(aggClassEst.T , labelArr)
